/**
 * Test script to send subscription confirmation email
 * Run: node send-subscription-confirmation-test.js (with Next.js dev server running)
 */
...
async function main() {
  console.log("🚀 Sending subscription confirmation email to test addresses\n");
