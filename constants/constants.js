    ...
    <tr>
      <td style="padding: 20px 18px; border-radius: 0 0 12px 12px;">
        ...
        <div style="text-align: center; border-top: 1px solid rgba(255, 255, 255, 0.1); padding-top: 10px;">
          ...
          <p style="color: rgba(255, 255, 255, 0.6); font-size: 9px; margin: 0;">You're receiving this because a friend invited you to Yookatale. <a href="https://www.yookatale.app/unsubscribe" style="color: rgba(255, 255, 255, 0.85); text-decoration: underline;">Unsubscribe</a></p>
        </div>
      </td>
    </tr>
  </table>
