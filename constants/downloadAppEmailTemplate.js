...
export const downloadAppEmailTemplate = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
          ...
          <tr>
            <td style="padding: 20px 18px; background-color: #ffffff;">
              <p style="color: #374151; font-size: 13px; line-height: 1.5; margin: 0 0 10px;">
                Download the Yookatale app to enjoy a seamless shopping experience! You have two easy ways to get the app: Visit <strong>yookatale.app</strong> on your browser and scroll down to the footer, where you'll find direct download links for both Google Play Store (Android) and App Store (iOS). Simply click on your preferred store button to download.
              </p>
              <p style="color: #4b5563; font-size: 12px; line-height: 1.5; margin: 0 0 16px;">
                Alternatively, you can open the <strong>Google Play Store</strong> (Android) or <strong>App Store</strong> (iOS) on your device, search for "<strong>Yookatale</strong>", and tap install. Once downloaded, sign in with your account and start shopping, subscribing, and earning rewards right from your phone!
              </p>
              ...
              <div style="background-color: #f9fafb; border-radius: 12px; padding: 12px; margin: 16px 0; border: 1px solid #e5e7eb;">
                <h3 style="color: #111827; font-size: 14px; font-weight: 700; margin: 0 0 8px; text-align: center;">How to Download the Yookatale App</h3>
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  <tr>
                    <td width="50%" style="padding: 0 4px 0 0; vertical-align: top;">
                      <div style="border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; background-color: #ffffff;">
                        <img src="https://www.yookatale.app/assets/images/app-download-web.png" alt="Download from Website Footer" style="display: block; width: 100%; height: auto; border: 0; max-height: 300px; object-fit: contain;" />
                        <div style="padding: 8px;"><p style="margin: 0; font-weight: 600; color: #111827; font-size: 11px;">Download from Website Footer</p></div>
                      </div>
                    </td>
                    <td width="50%" style="padding: 0 0 0 4px; vertical-align: top;">
                      <div style="border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; background-color: #ffffff;">
                        <img src="https://www.yookatale.app/assets/images/app-download-playstore.png" alt="Search in App Store" style="display: block; width: 100%; height: auto; border: 0; max-height: 300px; object-fit: contain;" />
                        <div style="padding: 8px;"><p style="margin: 0; font-weight: 600; color: #111827; font-size: 11px;">Search in App Store</p></div>
                      </div>
                    </td>
                  </tr>
                </table>
