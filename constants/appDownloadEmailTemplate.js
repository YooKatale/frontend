 ...
 * Shows two methods: (1) Visit website footer, (2) Search in app stores.
 */

export const appDownloadEmailTemplate = `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <title>Download Yookatale App - Get Started Today</title>
</head>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.06); border: 1px solid rgba(0, 0, 0, 0.05);">
          ...
          <tr>
            <td style="background-color: #000000; padding: 20px 20px; text-align: center;">
              ...
              <h1 style="color: #ffffff; font-size: 22px; font-weight: 800; margin: 0;">Get the Yookatale App</h1>
              <p style="color: #e0f2fe; font-size: 13px; margin: 6px 0 0;">Shop faster, track orders, and get exclusive mobile-only deals.</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 20px 18px; background-color: #ffffff;">
              ...
              <div style="margin-top: 20px; padding: 18px; background: linear-gradient(180deg, #f8fafc 0%, #f1f5f9 100%); border-radius: 12px; border: 1px solid #e2e8f0;">
                <h2 style="color: #0f172a; font-size: 18px; font-weight: 700; margin: 0 0 12px; text-align: center;">📱 How to Download the Yookatale App</h2>
                
                <!-- Method 1: Website Footer -->
                <div style="background-color: #ffffff; border-radius: 10px; padding: 16px; margin-bottom: 16px; border: 1px solid #e5e7eb;">
                  <h3 style="color: #111827; font-size: 15px; font-weight: 700; margin: 0 0 8px;">Method 1: Visit Our Website</h3>
                  <p style="color: #4b5563; font-size: 13px; line-height: 1.6; margin: 0 0 12px;">
                    Visit <strong>yookatale.app</strong> and scroll down to the footer. You'll find direct download links for both iOS and Android apps.
                  </p>
                  <div style="text-align: center; margin-top: 12px;">
                    <a href="https://www.yookatale.app" style="display: inline-block; padding: 10px 20px; background-color: #0a5c36; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 13px;">Visit yookatale.app</a>
                  </div>
                </div>

                <!-- Method 2: App Stores -->
                <div style="background-color: #ffffff; border-radius: 10px; padding: 16px; margin-bottom: 16px; border: 1px solid #e5e7eb;">
                  <h3 style="color: #111827; font-size: 15px; font-weight: 700; margin: 0 0 8px;">Method 2: Search in App Stores</h3>
                  <p style="color: #4b5563; font-size: 13px; line-height: 1.6; margin: 0 0 12px;">
                    Open the <strong>App Store</strong> (iOS) or <strong>Google Play Store</strong> (Android) on your device. Search for "<strong>Yookatale</strong>" and download the official app.
                  </p>
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 12px 0 0;">
                    <tr>
                      ...
                      <td align="center" width="50%" style="padding: 0 0 0 6px;">
                ...
                <p style="color: #64748b; font-size: 12px; margin: 16px 0 0; text-align: center; line-height: 1.5;">
                  Once downloaded, sign in with your account and start shopping, subscribing, and earning rewards!
                </p>
              </div>
            </td>
          </tr>
