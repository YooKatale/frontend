                  ...
                  <tr>
                    <td colspan="2" style="padding: 0 0 8px 0;">
                      <div style="border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; background-color: #ffffff;">
                        <img src="https://www.yookatale.app/assets/images/app-subscription-plans.png" alt="Choose Your Subscription Plan" style="display: block; width: 100%; height: auto; border: 0; max-height: 400px; object-fit: contain;" />
          ...
          <tr>
            <td style="background-color: #111827; padding: 20px 18px; border-radius: 0 0 12px 12px;">
              ...
              <div style="text-align: center; border-top: 1px solid rgba(255, 255, 255, 0.1); padding-top: 10px;">
                ...
                <p style="color: rgba(255, 255, 255, 0.6); font-size: 9px; margin: 0;">You're receiving this because you subscribed to Yookatale. <a href="https://www.yookatale.app/unsubscribe" style="color: rgba(255, 255, 255, 0.85); text-decoration: underline;">Unsubscribe</a></p>
              </div>
            </td>
          </tr>
        </table>
