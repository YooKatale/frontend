        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.06); border: 1px solid rgba(0, 0, 0, 0.05);">
          ...
          <tr>
            <td style="padding: 20px 18px; background-color: #ffffff;">
              <p style="color: #374151; font-size: 14px; line-height: 1.6; margin: 0 0 12px; font-weight: 600;">
                Subscribe to Yookatale and enjoy fresh, customizable meals delivered to your doorstep!
              </p>
              <p style="color: #4b5563; font-size: 13px; line-height: 1.6; margin: 0 0 16px;">
                You can subscribe to our <strong>meal calendar</strong> with ready-to-eat or ready-to-cook options, or choose from our <strong>subscription plans</strong> (Freemium, Premium, Family, or Business). Subscribe weekly or monthly for breakfast, lunch, supper, or all meals. Visit <a href="https://www.yookatale.app/subscription" style="color: #185f2d; text-decoration: underline; font-weight: 600;">yookatale.app/subscription</a> to get started.
              </p>
                  ...
                  <tr>
                    <td colspan="2" style="padding: 0 0 8px 0;">
                      <div style="border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; background-color: #ffffff;">
                        ...
                        <div style="padding: 8px;"><p style="margin: 0; font-weight: 600; color: #111827; font-size: 11px;">Step 1: Choose Your Subscription Plan</p></div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2" style="padding: 8px 0 8px 0;">
                      <div style="border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; background-color: #ffffff;">
                        <img src="https://www.yookatale.app/assets/images/meal-calendar-subscription.png" alt="Meal Calendar" style="display: block; width: 100%; height: auto; border: 0; max-height: 400px; object-fit: contain;" />
                        <div style="padding: 8px;"><p style="margin: 0; font-weight: 600; color: #111827; font-size: 11px;">Step 2: Select Your Meals (Ready-to-Eat or Ready-to-Cook)</p></div>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2" style="padding: 8px 0 0 0;">
                      <div style="border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden; background-color: #ffffff;">
                        <img src="https://www.yookatale.app/assets/images/payment-complete.png" alt="Complete Payment" style="display: block; width: 100%; height: auto; border: 0; max-height: 400px; object-fit: contain;" />
