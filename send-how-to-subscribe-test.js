/**
 * Test script to send how to subscribe email
 * Run: node send-how-to-subscribe-test.js (with Next.js dev server running)
 */
...
async function main() {
  console.log("🚀 Sending how to subscribe email to test addresses\n");
