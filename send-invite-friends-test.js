/**
 * Test script to send invite friends email
 * Run: node send-invite-friends-test.js (with Next.js dev server running)
 */
...
async function main() {
  console.log("🚀 Sending invite friends emails to test addresses\n");
