/**
 * Test script to send app download email
 * Run: node send-app-download-test.js (with Next.js dev server running)
 */
...
async function main() {
  console.log("🚀 Sending app download emails to test addresses\n");
