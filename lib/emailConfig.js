...
if (!emailUser || !emailPassword) {
  console.error(
    "❌ CRITICAL: Email credentials not found in environment variables. " +
    "Please set EMAIL_USER and EMAIL_PASSWORD in your environment. " +
    "Emails will NOT send until this is configured."
  );
  // In production, this should fail loudly to prevent silent failures
...
// Email address comes from environment variable for security
export const defaultSender = {
  name: "YooKatale",
  email: emailUser || "noreply@yookatale.app", // Sender email from environment (fallback for safety)
};
